...
const runtimePages = [
  ...
  'snapshot/index.html', 'contact/index.html', 'neighbor/index.html',
...
test('official logo is local, unchanged in markup, and shared CSS is reachable', () => {
  ...
  for (const stylesheet of ['styles.css', 'buyer.css', 'snapshot.css', 'referral-bridge.css']) {
...
test('408FARMERS mnemonic brand remains present for continuity', () => {
  const primaryPages = [
    ...
    'teachers/index.html', 'engineers/index.html', 'snapshot/index.html'
  ];
