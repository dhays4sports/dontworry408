/* 408-CALLBACK-1.2 — shared exact-time, anytime, or no-contact browser continuation. */
(function (window, document) {
  'use strict';
  var BUILD = '408-CALLBACK-1.2';
  ...
  function product(value) {
    ...
    if (normalized.indexOf('home') >= 0 || normalized.indexOf('buyer') >= 0 || normalized.indexOf('snapshot') >= 0 || normalized.indexOf('score') >= 0 || normalized.indexOf('tech') >= 0 || normalized.indexOf('teacher') >= 0 || normalized.indexOf('health') >= 0 || normalized.indexOf('engineer') >= 0) return 'home';
    return 'general';
  }
